...
const bool _webDavTraceEnabled =
    kDebugMode &&
    bool.fromEnvironment('STARFLOW_WEBDAV_TRACE', defaultValue: false);
const String _webDavTraceName = 'Starflow.WebDAV';
