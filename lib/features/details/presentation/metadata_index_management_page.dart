...
class _MetadataIndexManagementPageState
  ...
  late final FocusScopeNode _pageFocusScopeNode;
  ...
  void initState() {
    ...
    _pageFocusScopeNode =
        FocusScopeNode(debugLabel: 'metadata-index-page-scope');
  ...
  void _scheduleTelevisionFocusRecoveryIfLost() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (!mounted || _pageFocusScopeNode.hasFocus) {
        return;
      }
      final route = ModalRoute.of(context);
      final routeIsCurrent = route == null || route.isCurrent;
    ...
    return TvPageFocusScope(
      ...
      child: Scaffold(
        ...
        body: AppPageBackground(
          ...
          child: FocusScope(
            node: _pageFocusScopeNode,
            autofocus: isTelevision,
            onFocusChange: (hasFocus) {
              if (isTelevision && !hasFocus) {
