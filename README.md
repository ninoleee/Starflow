...
- 网络存储里开启“同步删除夸克目录”后，如果删除的是指向夸克网盘直链的 `WebDAV .strm` 文件，还会到当前夸克保存目录里同步删除匹配到的影片或剧集目录
...
- 网络存储页可直接管理当前夸克保存目录
  ...
  - 可选开启“同步删除夸克目录”：删除命中夸克直链的 `WebDAV .strm` 时，会同步删除当前夸克保存目录里的对应影片或剧集目录
