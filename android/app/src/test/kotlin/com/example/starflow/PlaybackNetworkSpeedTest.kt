...
class PlaybackNetworkSpeedTest {
    @Test fun activeMediaFormatAndDuration() {
        ...
        assertEquals("0s", NativePlaybackFormatting.formatBufferDuration(0))
        assertEquals("60s", NativePlaybackFormatting.formatBufferDuration(59999))
        assertEquals("90s", NativePlaybackFormatting.formatBufferDuration(90000))
        assertEquals("120s", NativePlaybackFormatting.formatBufferDuration(120000))
        assertEquals("3600s", NativePlaybackFormatting.formatBufferDuration(3600000))
        assertEquals("--", NativePlaybackFormatting.formatBufferDuration(null))
