...
internal fun NativeSubtitleTrackFingerprint.toJson(): JSONObject =
    JSONObject().apply {
        ...
        put("codec", if (sampleMimeType == androidx.media3.common.MimeTypes.APPLICATION_MEDIA3_CUES)
            codecs else sampleMimeType.ifEmpty { codecs })
        put("isImage", !NativeDualSubtitleTrackPolicy.isCompatibleTextSubtitle(sampleMimeType, codecs))
